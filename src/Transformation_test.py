...
diffy = np.diff(y)
print("Diferencia y: ", diffy)
diffz = np.diff(z)
print("Diferencia z: ", diffz)
sumOfSquares = diffx**2 + diffy**2 + diffz**2
print("Suma cuadrados: ", sumOfSquares)
sqrtOfSquares = np.sqrt(sumOfSquares)
print("Raíz Suma cuadrados: ", sqrtOfSquares)
sumDistance = np.sum(sqrtOfSquares)
print("Suma distancias: ", sumDistance)
